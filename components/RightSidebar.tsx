...
interface RightSidebarProps {
  ...
  onDownloadSingleFile: (fileName: string, content: string) => void;
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-white">
          ...
          <div className="h-12 border-b border-slate-200 px-3 flex items-center justify-between shrink-0 bg-slate-50 overflow-x-auto custom-scrollbar">
            ...
            <div className="flex items-center gap-1 shrink-0 ml-2">
              ...
              <button
                onClick={() => onDownloadSingleFile(selectedFile, activeContent)}
                disabled={!activeContent}
                title="Download file"
                className="p-1.5 rounded-lg border border-slate-200 bg-white text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-all disabled:opacity-40"
              >
        ...
        <div className="flex-1 p-4 overflow-y-auto custom-scrollbar space-y-6 bg-white">
          <div>
            ...
            <p className="text-xs text-slate-500 mb-4">
              Configure options and export generated code packages.
            </p>
            ...
            <div className="space-y-3">
              <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
                ...
                <p className="text-[11px] text-slate-500">
                  Download all generated website source files (`index.html`, `styles.css`, `script.js`).
                </p>
                <button
                  onClick={onDownloadAllFiles}
                  disabled={files.length === 0}
                  className="w-full py-2.5 px-3 rounded-xl font-semibold text-xs text-slate-800 bg-white hover:bg-slate-100 border border-slate-200 transition-all flex items-center justify-center gap-2 disabled:opacity-50 shadow-xs"
                >
                  <Download className="w-4 h-4 text-purple-600" />
                  <span>Download Code Bundle</span>
                </button>
              </div>
