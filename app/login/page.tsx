      ...
      <div className="w-full max-w-md flex flex-col items-center my-auto">
        ...
        <div className="w-full bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-xl shadow-slate-200/60">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold uppercase text-slate-700 tracking-wider mb-1.5">
                Email Address
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/10 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-900 placeholder-slate-400 outline-none transition-all disabled:opacity-50"
                />
              </div>
            </div>
          ...
          <p className="text-center text-xs text-slate-600 mt-6">
            ...
            <Link href="/signup" className="text-purple-600 hover:text-purple-700 font-semibold underline underline-offset-4">
              Sign up free
            </Link>
          </p>
        </div>
