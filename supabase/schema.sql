...
CREATE TABLE IF NOT EXISTS public.website_internal_links (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  website_id UUID NOT NULL REFERENCES public.websites(id) ON DELETE CASCADE,
  source_page_id UUID NOT NULL REFERENCES public.website_pages(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_internal_links_website ON public.website_internal_links(website_id);
...
-- ---------------------------------------------------------------------
-- 18. SEO PHASE 10: GENERIC THIRD-PARTY SEO INTEGRATION FRAMEWORK
-- ---------------------------------------------------------------------
